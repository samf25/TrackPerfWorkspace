#Tue Jul 30 11:18:42 2024"""Automatically generated. DO NOT EDIT please"""
import sys
...
class ACTSMergeHitCollections( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'Blocking' : False,
    'FilterCircularDependencies' : True,
    'InputCollection6' : DataHandle('Collection6', 'R', 'edm4hep::TrackerHitPlaneCollection'),
    'InputCollection5' : DataHandle('Collection5', 'R', 'edm4hep::TrackerHitPlaneCollection'),
    'InputCollection4' : DataHandle('Collection4', 'R', 'edm4hep::TrackerHitPlaneCollection'),
    'InputCollection3' : DataHandle('Collection3', 'R', 'edm4hep::TrackerHitPlaneCollection'),
    'InputCollection2' : DataHandle('Collection2', 'R', 'edm4hep::TrackerHitPlaneCollection'),
    'InputCollection1' : DataHandle('Collection1', 'R', 'edm4hep::TrackerHitPlaneCollection'),
  ...
  _propertyDocDct = { 
    ...
    'Blocking' : """ if algorithm invokes CPU-blocking system calls (offloads computations to accelerators or quantum processors, performs disk or network I/O, is bound by resource synchronization, etc) [Gaudi::Algorithm] """,
    'FilterCircularDependencies' : """ filter out circular data dependencies [Gaudi::Algorithm] """,
    'InputCollection6' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection5' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection4' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection3' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection2' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection1' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'OutputCollection' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::TrackerHitPlaneCollection>,std::tuple<edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection,edm4hep::TrackerHitPlaneCollection>,Gaudi::Functional::Traits::use_<> >] """,
  }
...
class ACTSMergeRelationCollections( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'Blocking' : False,
    'FilterCircularDependencies' : True,
    'InputCollection6' : DataHandle('Collection6', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'InputCollection5' : DataHandle('Collection5', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'InputCollection4' : DataHandle('Collection4', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'InputCollection3' : DataHandle('Collection3', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'InputCollection2' : DataHandle('Collection2', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'InputCollection1' : DataHandle('Collection1', 'R', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
    'OutputCollection' : DataHandle('MergedCollection', 'W', 'edm4hep::MCRecoTrackParticleAssociationCollection'),
  }
  _propertyDocDct = { 
    'ExtraInputs' : """  [DataHandleHolderBase<PropertyHolder<CommonMessaging<implements<IAlgorithm,IDataHandleHolder,IProperty,IStateful> > > >] """,
    'ExtraOutputs' : """  [DataHandleHolderBase<PropertyHolder<CommonMessaging<implements<IAlgorithm,IDataHandleHolder,IProperty,IStateful> > > >] """,
    ...
    'Blocking' : """ if algorithm invokes CPU-blocking system calls (offloads computations to accelerators or quantum processors, performs disk or network I/O, is bound by resource synchronization, etc) [Gaudi::Algorithm] """,
    'FilterCircularDependencies' : """ filter out circular data dependencies [Gaudi::Algorithm] """,
    'InputCollection6' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection5' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection4' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection3' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection2' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputCollection1' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'OutputCollection' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection,edm4hep::MCRecoTrackParticleAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
  }
...
class TrackTruthAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'Blocking' : False,
    'FilterCircularDependencies' : True,
    'InputTrackerHit2SimTrackerHitRelationName' : DataHandle('TrackMCRelation', 'R', 'edm4hep::MCRecoTrackerAssociationCollection'),
  ...
  _propertyDocDct = { 
    ...
    'Blocking' : """ if algorithm invokes CPU-blocking system calls (offloads computations to accelerators or quantum processors, performs disk or network I/O, is bound by resource synchronization, etc) [Gaudi::Algorithm] """,
    'FilterCircularDependencies' : """ filter out circular data dependencies [Gaudi::Algorithm] """,
    'InputTrackerHit2SimTrackerHitRelationName' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::TrackCollection,edm4hep::MCParticleCollection,edm4hep::MCRecoTrackerAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputMCParticleCollectionName' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::TrackCollection,edm4hep::MCParticleCollection,edm4hep::MCRecoTrackerAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'InputTrackCollectionName' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::TrackCollection,edm4hep::MCParticleCollection,edm4hep::MCRecoTrackerAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
    'OutputParticle2TrackRelationName' : """  [Gaudi::Functional::details::DataHandleMixin<std::tuple<edm4hep::MCRecoTrackParticleAssociationCollection>,std::tuple<edm4hep::TrackCollection,edm4hep::MCParticleCollection,edm4hep::MCRecoTrackerAssociationCollection>,Gaudi::Functional::Traits::use_<> >] """,
  }
